  ...
  options.forEach(function(option) {
    ...
    if (!!scope) {
      _.assignWith(self.$scope, scope, function scopeCustomizer(objectValue, sourceValue, key) {
        if (key === 'where') {
         //added to manage multiple scopes with $and
          if (sourceValue && sourceValue['$and'] != null && objectValue && objectValue['$and'] != null) {
            objectValue['$and'] = _.concat(objectValue['$and'], sourceValue['$and']);
            return objectValue;
          }
